...
export default class Register extends Component {
    constructor(props) {
        super(props);
        this.state = {
            firstName: "", lastName: "", role: "seller", phoneNo: "", address: "", email: "", password: "",
    ...
    handleSubmit = async (event) => {
        ...
        const { firstName, lastName, role, phoneNo, address, email, password } = this.state;
        let data = { firstName: firstName, lastName: lastName, role: role, phoneNo: phoneNo, address: address, email, password };
                                            ...
                                            <div className="card-body">
                                                <form>
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <input className="form-control py-3" type="text" placeholder="Enter lastName" name="role" value={this.state.role}/*  onChange={(e) => this.handleChangeUser(e)} */ />
                                                    </div>
                                                    <div className="form-group">
